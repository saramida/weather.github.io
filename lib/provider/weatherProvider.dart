...
class WeatherProvider with ChangeNotifier {
  String apiKey = '7a7d1d8e4f6f0a47cb70183202fa11c5';
  ...
  Future<void> getCurrentWeather(LatLng location) async {
    ...
    try {
      ...
      Trace.DebugPrintln("getCurrentWeather = " + extractedData.toString());
  ...
  Future<void> getDailyWeather(LatLng location) async {
    ...
    try {
      ...
      Trace.DebugPrintln("getDailyWeather = " + dailyData.toString());
  ...
  Future<void> searchWeatherWithLocation(String location) async {
    ...
    try {
      ...
      final extractedData = json.decode(response.body) as Map<String, dynamic>;
      weather = Weather.fromJson(extractedData);
      Trace.DebugPrintln("searchWeatherWithLocation = " + extractedData.toString());
      getDailyWeather(new LatLng(weather.lat,weather.long));
      getCurrentWeather(new LatLng(weather.lat,weather.long));
    } catch (error) {
      this.getWeatherData();
      //this.isRequestError = true;
      //throw error;
