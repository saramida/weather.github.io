...
class SevenDayForecast extends StatelessWidget {
  Widget dailyWidget(dynamic weather, BuildContext context,WeatherProvider wprovider) {
    ...
    DateTime dayOfWeek3 = weather.date;
    var dayOfWeek2= dayOfWeek3.toUtc().add(Duration(seconds: wprovider.weather.timezone));
    final dayOfWeek = DateFormat('EEE').format( dayOfWeek2 );
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Row(
                      children: weatherProv.sevenDayWeather
                          .map((item) => dailyWidget(item, context,weatherProv))
                          .toList(),
                    ),
                  );
                }),
